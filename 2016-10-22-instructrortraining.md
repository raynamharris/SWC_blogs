...
**Online** During  online workshops, the big screen projector is used for the webcast so that learners can see the instructor and the learners at other sites. I setup a whiteboard right behind my chair for drawing concept maps, so that I could use illustrations. Each student has their laptop open to the etherpad, and they can easily open links to webpages or videos that we give them. Since the student never see anything projected except for my face and my white board, maybe this means that I can do the in-person classes without using the projector....

**What does this mean for next time?** Next time I teach in person, I'm going to try not using the projector at all on Day 1 to highly encourage Etherpad note taking and communication, and I'll only use it on Day 2 only for live coding. For online workshops, I'll highly recommend using a white board *if* you can write clear enough that it can be read. 
